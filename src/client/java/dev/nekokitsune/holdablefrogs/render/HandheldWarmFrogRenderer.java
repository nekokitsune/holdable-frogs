...
public class HandheldWarmFrogRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    private FrogEntityModel<FrogEntity> frogModel;
    private final Identifier frogTexture = new Identifier("minecraft", "textures/entity/frog/warm_frog.png");
